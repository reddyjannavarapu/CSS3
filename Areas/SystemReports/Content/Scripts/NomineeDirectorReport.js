...
$(document).ready(function () {
    SetPageAttributes('liSystemReports', 'System Reports', 'Nominee Director Reports', 'liNomineeDirectorReport');
...
function BindddlNomineeDirector() {
    CallServices('GetMFeesByFeeType', 'ScriptNomineeDirector', 'ddlNomineeDirector', "{'FeeType':'ND'}", false, '');
}
