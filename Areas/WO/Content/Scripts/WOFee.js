$(document).ready(function () {
    ...
    $GlobalFeeData.resultPerPage = 50;
...
//function GetInvoicePreviewCallFee(FeeIDs) {
//    FeeCallServices("GetInvoicePreviewDataByFee", "", "", "{'FeeIDs':'" + FeeIDs + "'}", '', InvoicePreviewDetailsByFee);
...
function FeeDataCall() {
    try {
        FeeCallServices("GetFeeItemsByWOID", 'ScriptFeeItems', 'trFeeItemsData', "{WOID:" + parseInt($("#hdnWOID").val()) + ",'startPage':" + $GlobalFeeData.startPage + ",'resultPerPage':" + $GlobalFeeData.resultPerPage + "}", true, FeeDataListCallBack);
    } catch (e) {
        console.log(e);
    }
}
